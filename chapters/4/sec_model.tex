...
\begin{figure}[h]
    ...
    \caption{Typical branching ratios of scalar $\phi$ to a dimuon pair. Here we have taken the coupling strength between the muon and the scalar to be $g_{\phi \mu} = 10^{-4}$. Going slightly above the threshold mass to produce pairs of muons gives a branching ratio of $1$ almost immediately.}
