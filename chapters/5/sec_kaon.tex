...
\begin{figure}[h]
    ...
    \caption{Branching ratio of $K^+ \rightarrow \mu^+ \nu_\mu \phi$. The coupling is taken to be $g_{\phi\mu} = 10^{-4}$. There is an increased rate at extremely low energies, and a quick downturn near the kaon less the muon mass, where the phase space closes rapidly.}
    \label{fig:kaon_br}
\end{figure}
...
We've chosen to normalize to the two body decay rate here to remove any dependence on the kaon form factor.
