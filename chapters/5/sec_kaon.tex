...
This is preferential to a positron due to the increased coupling between the muon and electron.
...
\noindent $\lamba$ is defined as $\lambda(x,y,z) = x^2 + y^2 + z^2 - 2xy -2xz - 2yz$. 
...
Currently, the sensitivity discrepancy slightly above the pion mass is hard to justify, and may indicate that we do not indicate that background in this region correctly.
