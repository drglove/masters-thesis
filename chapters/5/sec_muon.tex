...
As an example spectrum, with both background and signal, we show Fig.\ \ref{fig:mu_eeenunu_scalar_spectrum}.
...
\begin{figure}[t]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \label{fig:mu_eeenunu_scalar_background}
    \end{subfigure}
...
This reduces the background within the bin to a much more reasonable level for sensitivity.
