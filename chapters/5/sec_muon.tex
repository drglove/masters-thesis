...
\begin{itemize}
    \item{The total width of the process is given, which we can use to rescale the events. \madgraph tallies this partial width for us. This will capture the overall zeroth-order behaviour of our signal, corresponding to the total number of raw signal events all placed into one bin.}
